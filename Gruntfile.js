module.exports = function( grunt ) {
  ...
  grunt.initConfig({
    ...
    // Jade templates
    // taking from http://www.thedjpetersen.com/blog/supercharging_yeoman/
    jade: {
      dist: {
        ...
        options: {
          ...
          locals: {
            ...
            date : function() {return {compiledAt: new Date()}}
          }
        }
      }
    },
    ...
    server: {
        all: 'clean lint compass jade watch',
    },
  ...
  grunt.registerTask('build', 'intro clean compass jade mkdirs usemin-handler rjs concat css min img rev usemin manifest copy time');
};
